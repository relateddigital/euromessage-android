...
***Jan 10, 2025*** - [Euromessage v5.3.6](https://github.com/relateddigital/euromessage-android/releases/tag/5.3.6)
...
```java
implementation 'com.github.relateddigital:euromessage-android:5.3.6'
```
