...
***Nov 25, 2024*** - [Euromessage v5.2.9](https://github.com/relateddigital/euromessage-android/releases/tag/5.2.9)
...
```java
implementation 'com.github.relateddigital:euromessage-android:5.2.9'
```
