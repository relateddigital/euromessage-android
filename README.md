...
***April 1, 2021*** - [Euromessage v4.4.0](https://github.com/relateddigital/euromessage-android/releases/tag/4.4.0)
...
```java
implementation 'com.github.relateddigital:euromessage-android:4.4.0'
```
