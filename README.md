...
***October 20, 2021*** - [Euromessage v5.0.0](https://github.com/relateddigital/euromessage-android/releases/tag/5.0.0)
...
```java
implementation 'com.github.relateddigital:euromessage-android:5.0.0'
```
