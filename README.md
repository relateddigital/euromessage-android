...
***July 29, 2021*** - [Euromessage v4.5.5](https://github.com/relateddigital/euromessage-android/releases/tag/4.5.5)
...
```java
implementation 'com.github.relateddigital:euromessage-android:4.5.5'
```
