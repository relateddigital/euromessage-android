...
***October 24, 2023*** - [Euromessage v5.2.5-google](https://github.com/relateddigital/euromessage-android/releases/tag/5.2.4-google)
...
```java
implementation 'com.github.relateddigital:euromessage-android:5.2.5-google'
```
