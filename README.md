...
***December 31, 2021*** - [Euromessage v5.1.0](https://github.com/relateddigital/euromessage-android/releases/tag/5.1.0)
...
```java
implementation 'com.github.relateddigital:euromessage-android:5.1.0'
```
