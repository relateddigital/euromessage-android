...
***October 11, 2021*** - [Euromessage v4.6.2](https://github.com/relateddigital/euromessage-android/releases/tag/4.6.2)
...
```java
implementation 'com.github.relateddigital:euromessage-android:4.6.2'
```
