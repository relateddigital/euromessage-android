...
***May 21, 2021*** - [Euromessage v4.4.6](https://github.com/relateddigital/euromessage-android/releases/tag/4.4.6)
...
```java
implementation 'com.github.relateddigital:euromessage-android:4.4.6'
```
