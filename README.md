...
***September 6, 2021*** - [Euromessage v4.6.0](https://github.com/relateddigital/euromessage-android/releases/tag/4.6.0)
...
```java
implementation 'com.github.relateddigital:euromessage-android:4.6.0'
```
