...
***July 22, 2023*** - [Euromessage v5.2.7-google](https://github.com/relateddigital/euromessage-android/releases/tag/5.2.6)
...
```java
implementation 'com.github.relateddigital:euromessage-android:5.2.7-google'
```
