...
***September 21, 2022*** - [Euromessage v5.2.0](https://github.com/relateddigital/euromessage-android/releases/tag/5.2.0
...
```java
implementation 'com.github.relateddigital:euromessage-android:5.2.0'
```
