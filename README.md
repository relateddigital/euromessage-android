...
***April 28, 2021*** - [Euromessage v4.4.2](https://github.com/relateddigital/euromessage-android/releases/tag/4.4.2)
...
```java
implementation 'com.github.relateddigital:euromessage-android:4.4.2'
```
