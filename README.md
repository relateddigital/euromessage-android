...
***December 30, 2021*** - [Euromessage v5.0.9](https://github.com/relateddigital/euromessage-android/releases/tag/5.0.9)
...
```java
implementation 'com.github.relateddigital:euromessage-android:5.0.9'
```
